...
int InstallShader(const GLchar *vShaderText, const GLchar *fShaderText) {
	...
	glUniform3f(getUniLoc(ShadeProg,	"LightPos"), 4.0, 4.0, 4.0);
...
int main( int argc, char *argv[] )
{
   ...
   Initialize();
	...
	getGLversion();
	//install the shader
	if (!InstallShader(textFileRead((char*)"GLSL_DiffuseV.glsl"), textFileRead((char*)"GLSL_DiffuseF_release.glsl"))) {
